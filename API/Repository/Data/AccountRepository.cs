        ...
        {          
            ...
            if(checkEmail != null)
            {
                ...
                if (original != null)
                {
                    ...
                    mail.From = new MailAddress("dimasforgoteverything@gmail.com", "Forgot Password!!", System.Text.Encoding.UTF8);
                    ...
                    client.Credentials = new System.Net.NetworkCredential("dimasforgoteverything@gmail.com", "GudangGaramF!lter");
                    client.Port = 587;
