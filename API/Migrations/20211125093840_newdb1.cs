    ...
    public partial class newdb1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tb_employee", x => x.NIK);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tb_m_account_tb_employee_NIK",
                        column: x => x.NIK,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tb_account_role", x => x.Id);
                    table.ForeignKey(
                        name: "FK_tb_account_role_tb_m_account_AccountNIK",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tb_account_role_AccountNIK",
